...
export const ADMIN_PUSAT_ENDPOINTS = {
  ...
  SHELTER: {
    ...
    DROPDOWN: {
      BY_WILBIN: (wilbinId) =>
        `/admin-pusat/dropdowns/wilbin/${wilbinId}/shelter`,
    },
  },
  ANAK: {
  ...
  RAPORT: {
    ...
    DETAIL: (childId, raportId) =>
      `/admin-pusat/anak/${childId}/raport/${raportId}`,
  },
  PRESTASI: {
    LIST: (childId) => `/admin-pusat/anak/${childId}/prestasi`,
    DETAIL: (childId, prestasiId) =>
      `/admin-pusat/anak/${childId}/prestasi/${prestasiId}`,
  },
  RIWAYAT: {
    LIST: (childId) => `/admin-pusat/anak/${childId}/riwayat`,
    DETAIL: (childId, riwayatId) =>
      `/admin-pusat/anak/${childId}/riwayat/${riwayatId}`,
  },
  KELUARGA: {
    ...
    SHELTER_BY_WILBIN: (wilbinId) =>
      `/admin-pusat/keluarga-shelter/${wilbinId}`,
  },
  ...
  TEMPLATE: {
    ...
    MATA_PELAJARAN: (kelas) =>
      `/admin-pusat/template-kurikulum/mata-pelajaran/${kelas}`,
    MATA_PELAJARAN_STATS: (mataPelajaran, kelas) =>
      `/admin-pusat/template-kurikulum/mata-pelajaran-stats/${mataPelajaran}/${kelas}`,
    ...
    BY_MAPEL: (mataPelajaran, kelas) =>
      `/admin-pusat/template-materi/by-mapel/${mataPelajaran}/${kelas}`,

    // Distribution
    DISTRIBUTION: {
      CABANG_LIST: "/admin-pusat/distribution/cabang",
      DISTRIBUTE_SINGLE: (templateId) =>
        `/admin-pusat/distribution/template/${templateId}`,
      ...
      SETTINGS: (templateId) =>
        `/admin-pusat/distribution/settings/${templateId}`,
      ...
      MARK_NOTIFICATION_READ: (id) =>
        `/admin-pusat/distribution/notifications/${id}/read`,
      SEND_REMINDER: (distributionId) =>
        `/admin-pusat/distribution/${distributionId}/reminder`,
    ...
    MONITORING: {
      ...
      TEMPLATE_USAGE: (templateId) =>
        `/admin-pusat/monitoring/template/${templateId}/usage`,
...
export const ADMIN_CABANG_ENDPOINTS = {
  ...
  REPORTS: {
    ...
    CHILD_ATTENDANCE: {
      ...
      DETAIL: (childId) =>
        `/admin-cabang/laporan/attendance/children/${childId}`,
    },
    TUTORS: "/admin-cabang/laporan/tutors",
    FILTERS: {
      CABANGS: "/admin-cabang/laporan/filters/cabangs",
      WILAYAH: "/admin-cabang/laporan/tutors/filters/wilayah",
      SHELTERS: "/admin-cabang/laporan/tutors/filters/shelters",
    },
  },
  KURIKULUM: {
    ...
    REMOVE_MATERI: (id, materiId) =>
      `/admin-cabang/kurikulum/${id}/materi/${materiId}`,
  },
  ...
  MATA_PELAJARAN: {
    ...
    BY_KATEGORI: (kategori) =>
      `/admin-cabang/mata-pelajaran/kategori/${kategori || ""}`,
...
export const ADMIN_SHELTER_ENDPOINTS = {
  ...
  RAPORT: {
    ...
    PREVIEW: (childId, semesterId) =>
      `/admin-shelter/raport/preview/${childId}/${semesterId}`,
    CHECK_EXISTING: (childId, semesterId) =>
      `/admin-shelter/raport/check-existing/${childId}/${semesterId}`,
    UPDATE_DETAIL: (raportId, detailId) =>
      `/admin-shelter/raport/${raportId}/detail/${detailId}`,
  ...
  PRESTASI: {
    ...
    DETAIL: (childId, prestasiId) =>
      `/admin-shelter/anak/${childId}/prestasi/${prestasiId}`,
    UPDATE: (childId, prestasiId) =>
      `/admin-shelter/anak/${childId}/prestasi/${prestasiId}`,
    DELETE: (childId, prestasiId) =>
      `/admin-shelter/anak/${childId}/prestasi/${prestasiId}`,
  },
  RIWAYAT: {
    ...
    DETAIL: (childId, riwayatId) =>
      `/admin-shelter/anak/${childId}/riwayat/${riwayatId}`,
    UPDATE: (childId, riwayatId) =>
      `/admin-shelter/anak/${childId}/riwayat/${riwayatId}`,
    DELETE: (childId, riwayatId) =>
      `/admin-shelter/anak/${childId}/riwayat/${riwayatId}`,
  },
  TUTOR: {
  ...
  TUTOR_HONOR: {
    ...
    GET_HISTORY: (tutorId) =>
      `/admin-shelter/tutor-honor/tutor/${tutorId}/history`,
    GET_STATISTICS: (tutorId) =>
      `/admin-shelter/tutor-honor/tutor/${tutorId}/statistics`,
    GET_MONTHLY_DETAIL: (tutorId, month, year) =>
      `/admin-shelter/tutor-honor/tutor/${tutorId}/month/${month}/year/${year}`,
    ...
    GET_TUTOR_PREVIEW: (tutorId) =>
      `/admin-shelter/tutor-honor/tutor/${tutorId}/preview`,
    GET_YEAR_RANGE: (tutorId) =>
      `/admin-shelter/tutor-honor/tutor/${tutorId}/year-range`,
  },
  KELOMPOK: {
    ...
    AVAILABLE_ANAK: (kelompokId) =>
      `/admin-shelter/kelompok/${kelompokId}/available-anak`,
    ADD_ANAK: (kelompokId) => `/admin-shelter/kelompok/${kelompokId}/add-anak`,
    REMOVE_ANAK: (kelompokId, anakId) =>
      `/admin-shelter/kelompok/${kelompokId}/remove-anak/${anakId}`,
    STATS: (kelompokId) => `/admin-shelter/kelompok/${kelompokId}/stats`,
    // Legacy endpoints (maintained for backward compatibility)
    AVAILABLE_CHILDREN: (shelterId) =>
      `/admin-shelter/kelompok/available-children/${shelterId}`,
    GROUP_CHILDREN: (kelompokId) =>
      `/admin-shelter/kelompok/${kelompokId}/children`,
    ADD_CHILD: (kelompokId) =>
      `/admin-shelter/kelompok/${kelompokId}/add-child`,
    REMOVE_CHILD: (kelompokId, childId) =>
      `/admin-shelter/kelompok/${kelompokId}/remove-child/${childId}`,
  ...
  KELUARGA: {
    ...
    SHELTER_BY_WILBIN: (wilbinId) =>
      `/admin-shelter/keluarga-shelter/${wilbinId}`,
  },
  PENGAJUAN_ANAK: {
  ...
  AKTIVITAS: {
    ...
    BY_SEMESTER: (semesterId) =>
      `/admin-shelter/aktivitas/by-semester/${semesterId}`,
    BY_MATERI: (materiId) => `/admin-shelter/aktivitas/by-materi/${materiId}`,
    DUPLICATE: (aktivitasId) =>
      `/admin-shelter/aktivitas/${aktivitasId}/duplicate`,
    STATS: "/admin-shelter/aktivitas-stats",
  },
  ATTENDANCE: {
    ACTIVITY_MEMBERS: (id) =>
      `/admin-shelter/attendance/activity/${id}/members`,
  },
  ...
  SURAT: {
    ...
    DETAIL: (childId, suratId) =>
      `/admin-shelter/anak/${childId}/surat/${suratId}`,
    UPDATE: (childId, suratId) =>
      `/admin-shelter/anak/${childId}/surat/${suratId}`,
    DELETE: (childId, suratId) =>
      `/admin-shelter/anak/${childId}/surat/${suratId}`,
    MARK_READ: (childId, suratId) =>
      `/admin-shelter/anak/${childId}/surat/${suratId}/read`,
  },
  RAPORT_FORMAL: {
    LIST: (childId) => `/admin-shelter/anak/${childId}/raport-formal`,
    CREATE: (childId) => `/admin-shelter/anak/${childId}/raport-formal`,
    DETAIL: (childId, raportId) =>
      `/admin-shelter/anak/${childId}/raport-formal/${raportId}`,
    UPDATE: (childId, raportId) =>
      `/admin-shelter/anak/${childId}/raport-formal/${raportId}`,
    DELETE: (childId, raportId) =>
      `/admin-shelter/anak/${childId}/raport-formal/${raportId}`,
  },
  HISTORI: {
    LIST: "/admin-shelter/laporan/histori",
    DETAIL: (id) => `/admin-shelter/laporan/histori/detail/${id}`,
    JENIS_HISTORI_OPTIONS:
      "/admin-shelter/laporan/histori/jenis-histori-options",
...
export const DONATUR_ENDPOINTS = {
  ...
  SURAT: {
    ...
    DETAIL: (childId, suratId) =>
      `/donatur/children/${childId}/surat/${suratId}`,
    MARK_READ: (childId, suratId) =>
      `/donatur/children/${childId}/surat/${suratId}/read`,
  },

  PRESTASI: {
    LIST: (childId) => `/donatur/children/${childId}/prestasi`,
    DETAIL: (childId, prestasiId) =>
      `/donatur/children/${childId}/prestasi/${prestasiId}`,
    MARK_READ: (childId, prestasiId) =>
      `/donatur/children/${childId}/prestasi/${prestasiId}/read`,
  },

  RAPORT: {
    LIST: (childId) => `/donatur/children/${childId}/raport`,
    DETAIL: (childId, raportId) =>
      `/donatur/children/${childId}/raport/${raportId}`,
    SUMMARY: (childId) => `/donatur/children/${childId}/raport-summary`,
  },

  AKTIVITAS: {
    LIST: (childId) => `/donatur/children/${childId}/aktivitas`,
    DETAIL: (childId, aktivitasId) =>
      `/donatur/children/${childId}/aktivitas/${aktivitasId}`,
    ATTENDANCE_SUMMARY: (childId) =>
      `/donatur/children/${childId}/attendance-summary`,
  },
  ...
  MARKETPLACE: {
    ...
    CHILD_PROFILE: (childId) =>
      `/donatur/marketplace/children/${childId}/profile`,
    SPONSOR_CHILD: (childId) =>
      `/donatur/marketplace/children/${childId}/sponsor`,
